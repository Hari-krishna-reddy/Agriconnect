...
SECRET_KEY = 'django-insecure-$n=9v#f#wvk^$9%r=i$w@9quv__9w^(8$l0ux4&&s)h*$hmxhc'
...
#adding path to media 


# Path where media files will be stored on your filesystem
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

# URL that will be used to access media files
MEDIA_URL = '/media/'
